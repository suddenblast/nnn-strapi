...
export interface ApiShowShow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ep: Schema.Attribute.Relation<'manyToMany', 'api::staff.staff'>;
...
export interface ApiStaffStaff extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'John Smith'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dek: Schema.Attribute.String;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    headline: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Headline goes here'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
